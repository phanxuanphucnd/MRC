...
from modeling_xlm_roberta import XLMRobertaForQuestionAnsweringAVPool, XLMRobertaForQuestionAnsweringAVPoolBCEV3
...
MODEL_CLASSES = {
    'xlm-roberta': (XLMRobertaConfig, XLMRobertaForQuestionAnsweringAVPoolBCEV3, XLMRobertaTokenizer),
}
