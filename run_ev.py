    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {'input_ids':      batch[0],
                      ...
                      'labels':         batch[3]}
            if args.model_type != 'distilbert' and args.model_type != 'bartpho-syllable':
                inputs['token_type_ids'] = batch[2] if args.model_type in ['bert', 'xlnet', 'bartpho-syllable'] else None  # XLM, DistilBERT and RoBERTa don't use segment_ids
